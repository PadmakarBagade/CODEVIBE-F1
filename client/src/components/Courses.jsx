    ...
    <div style={{ maxWidth: "1400px", margin: "0 auto", padding: "0 20px" }}>
      ...
      {filteredCourses.length > 0 ? (
            ...
            <Link
              ...
              onClick={(e) => {
                if (!user) {
                  e.preventDefault();
                  navigate("/login", {
                    state: { from: { pathname: course.link } },
                  });
                }
              }}
              style={{
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.borderColor = wishlist.includes(
                  course.title,
                )
                  ? "rgba(255,75,110,0.6)"
                  : "rgba(255,255,255,0.2)";
        ...
        <EmptyState
          icon={<FaBookOpen />}
          title={
            showWishlistOnly ? "No Wishlisted Courses" : "No Courses Found"
          }
          description={
            showWishlistOnly
